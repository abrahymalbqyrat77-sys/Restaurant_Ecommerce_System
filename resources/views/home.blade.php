...
@section('page-content')
                ...
                <div class="col-lg-4">
                    <div class="left-content">
                        <div class="inner-content">
                            <h3>مطعم المهندس ابراهيم</h3>
                            <h4>THE BEST EXPERIENCE</h4>
                            <div class="main-white-button scroll-to-section">
                                <a href="#reservation"><h2>احجز طاولة</h2></a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 offset-lg-3">
                                        <ul>
                                          ...
                                          <li><a href='#tabs-1'><img src="{{ asset('assets/images/tab-icon-01.png')}}" alt="">فطور</a></li>
                                          <li><a href='#tabs-2'><img src="{{ asset('assets/images/tab-icon-02.png')}}" alt="">غداء</a></a></li>
                                          <li><a href='#tabs-3'><img src="{{ asset('assets/images/tab-icon-03.png')}}" alt="">عشاء
</a></a></li>
 ...
 as $item)
                            ...
                            class="btn" type="submit" value="تصفح الكل"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="section-heading" >
                        ...
                        <h2>تشكيلة متنوعة من أشهى الأطباق</h2>
                    </div>
                </div>
            </div>
        </div>
      ...
      <br>
                                ...
                                @if($product->available=="Stock")
                                  ...
                                  <input type="number" name="number" style="width:50px;" id="myNumber" value="1">
                                    <input type="submit" class="btn btn-success" value="أضف للسلة">
                                  </form>
                                @endif
                                ...
                                @if($product->available!="Stock")
                                  <form method="post" action="{{route('cart.store',$product->id)}}">
                                     @csrf
                                  <input type="number" name="number" style="width:50px;" id="myNumber" value="1">
                                    <input type="submit" class="btn btn-success" disabled value="أضف للسلة">
                                  </form>
                                @endif
                                </div>
                              </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 offset-lg-4 text-center">
                    <div class="section-heading">
                        <h6>طاقمنا</h6>
                        <h2>نقدم لك أفضل المكونات وأشهى الأطباق</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="left-text-content">
                        <div class="section-heading">
                            <h6>تواصل معنا</h6>
                            <h2>Here You Can احجز طاولة Or Just walkin to our cafe</h2>
                        </div>
                        <p>نحن في مطعم المهندس ابراهيم دائماً هنا لخدمتك - سوريا، دمشق، الميدان</p>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="phone">
                                    <i class="fa fa-phone"></i>
                                    <h4>أرقام الهاتف</h4>
                                    <span><a href="#">0936078549</a>
									<br><a href="#">0936078549</a>
									</span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="message">
                                    ...
                                    <span><a href="mailto:abrahymalbqyrat77@gmail.com">abrahymalbqyrat77@gmail.com</a><br>
									<a href="mailto:abrahymalbqyrat77@gmail.com">abrahymalbqyrat77@gmail.com</a><br>
									</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="contact-form">
                        <form id="contact" action="/reserve/confirm" method="post">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                              <input name="email" type="text" id="email" pattern="[^ @]*@[^ @]*" placeholder="البريد الإلكتروني" required="">
                            </fieldset>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="number-guests" name="no_guest" id="number-guests">
                                    <option value="number-guests">عدد الأشخاص</option>
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="time" name="time" id="time">
                                    ...
                                    <option name="فطور" id="فطور">فطور</option>
                                    <option name="غداء" id="غداء">غداء</option>
                                    <option name="عشاء
" id="عشاء
">عشاء
</option>
                            ...
                            <div class="col-lg-12">
                              <fieldset>
                                <textarea name="message" rows="6" id="message" placeholder="رسالة" required=""></textarea>
                              </fieldset>
                            </div>
                            <div class="col-lg-12">
                              <fieldset>
                                <button type="submit" id="form-submit" class="main-button-icon">احجز طاولة</button>
                              </fieldset>
                            </div>
                          </div>
                        </form>
