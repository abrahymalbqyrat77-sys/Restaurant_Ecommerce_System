        ...
        <div class="container">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="/trace-my-order">تتبع الطلب</a></li>

                            <li class="scroll-to-section"><a href="/my-order">طلباتي</a></li>
                          
                            <li class="scroll-to-section"><a href="/#chefs">Chefs</a></li> 
                            <li class="scroll-to-section"><a href="/#reservation">تواصل معنا</a></li>
                            ...
                            <li>
                                ...
                                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                                    ...
                                    @else
                                      <li>
                                        <a href="{{ route('login') }}" class="text-sm text-gray-700 underline">دخول</a>
                                      </li>
                                        @if (Route::has('register'))
                                            <li><a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline">تسجيل</a> </li>
                                        @endif
                                    @endauth
                                </div>
                                @endif
            ...
            <div class="row">
                <div class="col-lg-4 col-xs-12">
                    <div class="right-text-content">
                            <ul class="social-icons">
                                <li><a href="https://www.facebook.com/share/1BMXEm6RMc/"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
                                <li><a href="https://www.instagram.com/lbrahim_bk?igsh=MTdyZzN3djBhc2E5MA=="><i class="fa fa-instagram"></i></a></li>
                            </ul>
                    </div>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="left-text-content">
                        <p>© © مطعم المهندس ابراهيم
							<br>سوريا - دمشق - الميدان</p>
                    </div>
                </div>
            </div>
        </div>
